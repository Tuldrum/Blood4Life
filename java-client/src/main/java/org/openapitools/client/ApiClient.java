...
public class ApiClient {
    ...
    private String basePath = "https://api.chat-api.com";
    ...
    public ApiClient() {
        ...
        authentications.put("instanceId", new ApiKeyAuth("query", "instanceId"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.chat-api.com
