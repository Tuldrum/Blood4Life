...
public class WebhookUrl {
   ...
   * @return webhookUrl
  **/
  @ApiModelProperty(required = true, value = "Http or https URL for receiving notifications. For testing, we recommend using [our RequestBin](http://bin.chat-api.com).")
