...
public class Factory {
	...
	public IClienteRepository getClienteRepository() {
		...
		try {
			result = (IClienteRepository) Class.forName(Utilities.loadProperty("ClienteRepository"))
                                .getConstructor(IConnectionRepository.class).newInstance(getConn());
		} catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
				| IllegalAccessException | IllegalArgumentException | InvocationTargetException ex) {
			Logger.getLogger(Factory.class.getName()).log(Level.SEVERE, null, ex);
	...
	public ILugaresRepository getLugaresRepository() {
		...
		try {
			result = (ILugaresRepository) Class.forName(Utilities.loadProperty("LugaresRepository"))
                                .getConstructor(IConnectionRepository.class).newInstance(getConn());
		} catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
				| IllegalAccessException | IllegalArgumentException | InvocationTargetException ex) {
			Logger.getLogger(Factory.class.getName()).log(Level.SEVERE, null, ex);
		...
		try {
			result = (ICitaRepository) Class.forName(Utilities.loadProperty("CitaRepository"))
                                .getConstructor(IConnectionRepository.class).newInstance(getConn());
		} catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
				| IllegalAccessException | IllegalArgumentException | InvocationTargetException ex) {
			Logger.getLogger(Factory.class.getName()).log(Level.SEVERE, null, ex);
