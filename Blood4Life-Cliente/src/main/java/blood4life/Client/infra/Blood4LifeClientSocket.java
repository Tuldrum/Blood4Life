package blood4life.Client.infra;
 ...
 */
public class Blood4LifeClientSocket {
    ...
    public String sendRequest(String requestJson) throws IOException {
        ...
        Logger.getLogger(Blood4LifeClientSocket.class.getName()).log(Level.INFO, "Lo que se le envia al: ("+requestJson+")");
        ...
        Logger.getLogger(Blood4LifeClientSocket.class.getName()).log(Level.INFO, "Lo que se lee del servidor: ("+response+")");
    ...
    public void disconnect() {
        ...
        try {
            ...
            Logger.getLogger(Blood4LifeClientSocket.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
