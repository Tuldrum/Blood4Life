...
import static blood4life.Client.infra.Messages.warningMessage;
import static blood4life.Client.infra.Messages.successMessage;
...
public class GUIMenuUsuario extends javax.swing.JFrame {
    ...
    /*private void ponerUsuarioLogueado() {
        ...
        if (co.unicauca.travelagency.client.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + co.unicauca.travelagency.client.infra.Security.usuario.getLogin() + ")");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUIMenuUsuario ins = new GUIMenuUsuario();
